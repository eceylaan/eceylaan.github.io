    ...
    <div className="container">
      ...
      <div className="img-container">
        ...
        <div className="img-container-content">
          ...
          <p>
            I love working with others to create beautiful design solutions. I’ve designed everything from brand illustrations to
            complete mobile apps. I’m also handy with a camera!
          </p>
      ...
      <div className="footer-content">
        <div className="footer-text">
          ...
          <p>
            I’d love to have a chat to see how I can help you. The best first step is for us to discuss your project during a free
