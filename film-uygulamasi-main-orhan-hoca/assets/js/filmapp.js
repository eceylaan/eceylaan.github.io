...
function handleDeleteBtn(e) {
  ...
  //confirm alert gibi düşünebilirsin
...
// map kullandık çünkü herhangi bir arrayin her elemanı için bir işlem yapmış oluyoruz (normal klasik array fonksiyonu döndüğü için)
  document
    .querySelectorAll(".movieDeleteBtn")
    .forEach((x) => x.addEventListener("click", handleDeleteBtn));
//forEach kullandık çünkü elementler farklı bi tipte array oluşturuyor(NodeList) ve bu listenin sıradan arraylere
// göre farklı özellikleri var (element arrayi döndüğü için)
  document
