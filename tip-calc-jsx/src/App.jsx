      ...
      <div className="splitter">
        <form id="splitterForm">
          <div className="splitter-left">
            ...
            <p>Select Tip %</p>
            <div className="tip">
              <button className="btn1" type="button" onClick={() => handleTipClick(5)}>
                {" "}
                %5
              </button>
              <button className="btn2" type="button" onClick={() => handleTipClick(10)}>
                %10
              </button>
              <button className="btn3" type="button" onClick={() => handleTipClick(15)}>
                %15
              </button>
              <button className="btn4" type="button" onClick={() => handleTipClick(25)}>
                %25
              </button>
              <button className="btn5" type="button" onClick={() => handleTipClick(50)}>
                %50
              </button>
              <input
                className="custom"
                type="number"
                onChange={(e) => handleTipClick(e.target.value)}
                placeholder="CUSTOM"
                name="custom-tip"
              />
            </div>
          ...
          <div className="splitter-right">
            ...
            <button type="button" onClick={clickResetBtn} className="reset">
              RESET
            </button>
          </div>
        </form>
